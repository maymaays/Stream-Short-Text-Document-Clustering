...
As seen  in column \nameref*{perf} in Table \ref{tbl:tab1}, the performance comparison between stream clustering algorithms, SE-Stream has better performance since it tried to reduce the number of dimensions in the incoming data before using them to compute the clusters (Column \nameref*{algor}, Table \ref{tbl:tab1}).
